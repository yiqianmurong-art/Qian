...
import { Bike, Zap, Leaf, ArrowRight, ChevronRight, MapPin } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              ...
              <li className="hover:text-primary cursor-pointer transition-colors" onClick={() => document.getElementById('how-it-works')?.scrollIntoView({ behavior: 'smooth' })}>How it Works</li>
            </ul>
          </div>
